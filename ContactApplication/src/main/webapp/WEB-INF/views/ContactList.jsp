...
<body>
	<table border="1" width="80%" align="center">
		...
		<tr>
			<td height="350px">
				<h3>Contact List</h3> <c:if test="${param.msg eq 'del' }">
				...
				<form action='<s:url value="/user/bulkContactDelete"/>'>
					<button>Delete Select Records</button>
						...
						<tbody>
							...
							<c:if test="${contactList !=null }">
								<c:forEach var="con" items="${contactList }" varStatus="st">
									<tr>
										<!--  <td>${st.count }</td>-->
										<td align="center"><input type="checkbox" value="${con.contactId }" name="cid"></td>
										...
										<td><a href="${url_edit }">Edit</a> | <a
											href="${url_del }">Delete</a></td>
