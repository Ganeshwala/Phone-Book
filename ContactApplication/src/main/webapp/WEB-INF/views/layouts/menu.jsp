...
<c:if test="${sessionScope.userId!=null && sessionScope.userRole==2 }">
	<!-- User Menu -->
	<a href="${pageContext.request.contextPath }/user/dashbord">Home</a> | <a href="${pageContext.request.contextPath }/user/contactForm">Add Contact</a> | <a href="#">Contact List</a> | <a href="#">About</a> | <a href="#">Logout</a>
</c:if>
